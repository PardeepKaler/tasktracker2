defmodule TasktrackerWeb.TaskControllerTest do
  ...
  @create_attrs %{assigned: "some assigned", completed: true, description: "some description", timeSpent: "120.5", title: "some title"}
  ...
  def fixture(:task) do
    {:ok, task} = TaskTrack.create_task(@create_attrs)
    task
  end
